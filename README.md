...
The script initially was quite simple and easy to understand - it has been modified with google ai search (which helped me to find the right statments easier.
...
As i found that it was maybe nicer for a solution to be platform independent i decided to switch from the script to a more platform independent solution using go language.
